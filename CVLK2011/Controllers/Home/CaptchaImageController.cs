...
namespace CVLK2011.Controllers.Home
{
    public class CaptchaImageController : Controller
    {
        ...
        //private const string FontFamily = "Matura MT Script Capitals";
        private const string FontFamily = "Arial";
        private readonly static Brush Foreground = Brushes.RoyalBlue;
        private readonly static Color Background = Color.Snow;
        ...
        public void Render(string challengeGuid)
        {
            ...
            //string solution = (string)Request.RequestContext.HttpContext.Session[key];
            if (solution != null)
            {
