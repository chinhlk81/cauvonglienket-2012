<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<IEnumerable<CVLK2011.Models.OlineSupport>>" %>
 ...
 <img src="http://opi.yahoo.com/online?u=<%=item.OSYahoo1 %>&m=g&t=1" border="0" alt="Ho tro khach hang 24/24" align="absmiddle" /></a>
</td>
                        <td>
                           <a href="ymsgr:sendIM?<%=item.OSYahoo2 %>">
 <img src="http://opi.yahoo.com/online?u=<%=item.OSYahoo2 %>&m=g&t=1" border="0" alt="Ho tro khach hang 24/24" align="absmiddle" /></a>
</td>
                    </tr>
                    <tr>
                        <td>
