...
<!--%using (Html.BeginForm("Register", "Home", FormMethod.Post, new { entype="multipar/form-data"}))
  { %-->
  <% using (Ajax.BeginForm("Register", "Home", new AjaxOptions { HttpMethod = "POST", UpdateTargetId = "CaptchaHolder", LoadingElementId = "loading" }, new { @name = "frgt" }))
     {%>
			    ...
			    <tbody>
                    ...
                    <tr>
						...
						<tr>
							...
							<tr>
								<td valign="top" align="center" colspan="4" 
                                    style="font-size:12px;font-style:italic;color:#666666">(Thông tin này giúp <strong>Cầu Vồng Liên Kết</strong> tìm 1 nửa cho bạn tốt hơn)</td>
							</tr>
                            <tr>
                            ...
                            <img src="../../Images/ajax_loader.gif" alt="dang load..."/>
                            </div>
                            </td>
                                <td align="left">
							...
							<tr>
								<td align="center" colspan="4">
								    <input  id="button" class="btn_dangky_home" value="Đăng ký" type="submit" name="submit" onclick="return CheckInput()"/>
