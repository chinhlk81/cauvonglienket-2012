...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width:750px;text-align:left;font-weight:bold;color:#000;">
            <tr>
                <td colspan="5" style="color:#3B5998;border-top:1px solid #ccc;background:#EEF1F5">
                   <%=Html.Encode(Model.CurrentEvent.EventTime) %> &nbsp;Ngày&nbsp;
                   
                        <%=Html.Encode(Model.CurrentEvent.EventDate.ToString("dd/MM/yyyy"))%>
                   </td>
                   
                   <td style="color:#3B5998;border-top:1px solid #ccc;background:#EEF1F5">
                   <%if (!string.IsNullOrEmpty(Model.CurrentEvent.EventMusic))
                    {%><embed type="application/x-shockwave-flash" src="../../../lib/AudioPlayer.swf" quality="best" flashvars="audioUrl=<%=
                            Model.CurrentEvent.EventMusic%>&autoPlay=true" height="27" width="400" allowscriptaccess="always" wmode="transparent" backcolor="EBEAF0" frontcolor="ffffff" ><%
                    }%></td>
            </tr>
            <tr>
           ...
           <br />
            ...
            <tr>
             ...
             <%=Html.TextArea("FckEditor1", Model.CurrentEvent.EventContent, new { @readonly = "true", Style = "visibility:hidden;" })%>
                </td>
            </tr>
