          ...
          foreach (var item in Model.Albums)
          {
            ...
            <tr>
                <td class="photoalbum_frame" style="height:175px">
                    ...
                    <a style="position:relative;top:-10px" href="<% =Url.Action("ChiTietAlbum", "Home", new {id = item.AlbumID})%>">
                        <%
                  if (item.AlbumImgTitle != null)
                  {%>
                    <img src="<%=item.AlbumImgTitle%>" alt="" width="194px" height="120" />
                    <%}
                  else
                  {%>
                    <img src="<%=item.AlbumImgTitle%>" alt="" width="194px" height="120" />
