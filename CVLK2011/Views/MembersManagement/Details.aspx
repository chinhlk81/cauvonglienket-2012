            ...
            <tr class="detail_member_top">
                <td style="width: 152px" rowspan="2">
                   ...
                   <div>
                       ...
                       <div style="text-align:right"><a href="<%=Url.Action("UpdateAvatar","MembersManagement",new{id=Model.UserID}) %>"> <img alt="Xoá" src="../../../Images/deleteIcon.gif"  onclick="return ConfirmUpdateAvatar()" /></a></div>
                       </td>
                ...
                <td rowspan="2">
                    ...
                    <%if (Model.UserStatus == CVLK2011.Models.Utilities.cstNewStatus)
                      { %>
                    <img src="../../../Images/new_icon.gif" width="25px" height="25px" alt="" />
                    <%} %>
                    </td>
                    <td rowspan="2">
       ...
       <hr style="border-width:inherit; margin-left:0"/>
           ...
           <td colspan="2">
            ...
            <td style="height:300px">
             ...
             <input id="btAdd" type="submit"  value="Up Video" onclick="return CheckInputVideo()"/>
             <div id="dvEmail" style="visibility:visible"> Chọn video trước khi tải lên. Chỉ hỗ trợ video định dạng FLV.</div>
