   ...
   <a href="<%=Url.Action("Index","EventManagement")%>"><img src="/../Images/admin_back.png" alt="Trở về" /></a></div>
    <div>
        <table class="table_detail_admin">
            <tr>
                <td>Nhạc nền</td>
                <td><embed type="application/x-shockwave-flash" src="../../../lib/AudioPlayer.swf" quality="best" flashvars="audioUrl=<%=Model.EventMusic %>" height="27" width="400" allowscriptaccess="always" wmode="transparent" backcolor="EBEAF0" frontcolor="ffffff" ></td>
            </tr>
            <tr>
                <td>
