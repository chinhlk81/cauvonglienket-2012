...
<%: Html.PageLinks(Model.PagingInfo,
    x => Url.Action("Index", new {userID = Model.albumUserFilter, albumType = Model.albumTypeFilter, albumStatus = Model.albumStatusFilter, page = x, category = Model.CurrentCategory})) %>
</div>