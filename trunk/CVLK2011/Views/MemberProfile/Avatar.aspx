...
<tr>
<td>
<%if (Model.UserAvatarUpload == null)
{%>
    <img src="/<%=Model.UserPicture%>" alt="<%=Model.UserFullName%>" style="height:190px;width:250px" />
    <%
}else
{
%>
    <img src="/<%=Model.UserAvatarUpload%>" alt="<%=Model.UserFullName%>" style="height:190px;width:250px" />
 <% }%>
</td>
<td style="Width:100%">

<%=Html.Encode(ViewData["AvatarMessage"]) %></td>
</tr>
<tr>
<td>
