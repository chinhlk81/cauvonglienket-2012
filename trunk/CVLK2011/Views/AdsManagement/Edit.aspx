...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% using (Html.BeginForm("Edit", "AdsManagement", new {id=Model.AdID }, FormMethod.Post, new { enctype = "multipart/form-data" }))
       {%>
        <%: Html.ValidationSummary(true)%>

        <fieldset>
            <h2 class="manager_title">Chỉnh sửa quảng cáo</h2>
            ...
            <div class="editor-field">
               <%-- <%: Html.DropDownList("status", ViewData["Status"] as SelectList,Utilities.AliasDictionary[Model.AAStatus])%>--%>
        ...
        <%} %>
            ...
            <div class="editor-field">
                <%= Html.TextArea("FckEditor1", Model.AdContent, new { @name = "FckEditor1", Style = "visibility:hidden" })%>
